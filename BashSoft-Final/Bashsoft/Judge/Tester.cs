...
namespace BashSoft
{
    ...
    {
        public void CompareContent(string userOutputPath, string expectedOuputPath)
        {
            OutputWriter.WriteMessageOnNewLine("Reading files...");
            try
            {               
                string mismatchPath = this.GetMismatchPath(expectedOuputPath);
                string[] actualOutputLines = File.ReadAllLines(userOutputPath);
                string[] expectedOutputLines = File.ReadAllLines(expectedOuputPath);
                bool hasMismatch;
        ...
        private void PrintOuput(string[] mismatches, bool hasMismatch, string mismatchPath)
        {
            if (hasMismatch)
            {
